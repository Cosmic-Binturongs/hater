...
import ErrorBirds from "../images/ErrorBirds.png"
        ...
        <div className="leftWing"></div>
          <div className="floppingBird">
            ...
            <div className="eyeContainer">
              <div className="eyes"><div className="eyeLids"></div><div className="pupils"></div></div>
              <div className="beekContainer"><div className="beek"></div></div>
              <div className="eyes"><div className="eyeLids"></div><div className="pupils"></div></div>
            </div>
          </div>
